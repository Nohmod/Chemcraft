...
public class ProcedureBattery extends ElementsChemcraft.ModElement {
	public ProcedureBattery(ElementsChemcraft instance) {
		super(instance, 198);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure Battery!");
			return;
		}
