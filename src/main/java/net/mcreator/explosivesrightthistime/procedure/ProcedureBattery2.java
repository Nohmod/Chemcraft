...
public class ProcedureBattery2 extends ElementsChemcraft.ModElement {
	public ProcedureBattery2(ElementsChemcraft instance) {
		super(instance, 356);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure Battery2!");
			return;
		}
