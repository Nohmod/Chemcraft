...
public class ProcedureMoltensaltelectrodes extends ElementsChemcraft.ModElement {
	public ProcedureMoltensaltelectrodes(ElementsChemcraft instance) {
		super(instance, 410);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure Moltensaltelectrodes!");
			return;
		}
