 ...
 *
 *    Keep the ElementsChemcraft object in this class and all calls to this object
...
public class Chemcraft {
	...
	public static final SimpleNetworkWrapper PACKET_HANDLER = NetworkRegistry.INSTANCE.newSimpleChannel("chemcraft:a");
	@SidedProxy(clientSide = "net.mcreator.explosivesrightthistime.ClientProxyChemcraft", serverSide = "net.mcreator.explosivesrightthistime.ServerProxyChemcraft")
	public static IProxyChemcraft proxy;
	@Mod.Instance(MODID)
	public static Chemcraft instance;
	public ElementsChemcraft elements = new ElementsChemcraft();
	@Mod.EventHandler
	public void preInit(FMLPreInitializationEvent event) {
		MinecraftForge.EVENT_BUS.register(this);
		GameRegistry.registerWorldGenerator(elements, 5);
		GameRegistry.registerFuelHandler(elements);
		NetworkRegistry.INSTANCE.registerGuiHandler(this, new ElementsChemcraft.GuiHandler());
