...
public class ItemSilverfulminate extends ElementsChemcraft.ModElement {
	@GameRegistry.ObjectHolder("chemcraft:silverfulminate")
	public static final Item block = null;
	public ItemSilverfulminate(ElementsChemcraft instance) {
		super(instance, 9);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("chemcraft:silverfulminate", "inventory"));
	}
	public static class ItemCustom extends Item {
		public ItemCustom() {
			setMaxDamage(0);
			maxStackSize = 64;
			setUnlocalizedName("silverfulminate");
			setRegistryName("silverfulminate");
		...
		public EnumActionResult onItemUseFirst(EntityPlayer entity, World world, BlockPos pos, EnumFacing direction, float hitX, float hitY,
			...
			int z = pos.getZ();
			{
				...
				ProcedureSilverfulminateRightClickedOnBlock.executeProcedure($_dependencies);
			}
			return retval;
		}
