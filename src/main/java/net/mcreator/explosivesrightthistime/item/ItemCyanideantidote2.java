...
import net.mcreator.explosivesrightthistime.procedure.ProcedureCyanideantidote2FoodEaten;
	...
	public static class ItemFoodCustom extends ItemFood {
		...
		protected void onFoodEaten(ItemStack itemStack, World world, EntityPlayer entity) {
			...
			int z = (int) entity.posZ;
			{
				...
				ProcedureCyanideantidote2FoodEaten.executeProcedure($_dependencies);
			}
		}
	}
}
