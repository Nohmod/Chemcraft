...
public class BlockElectricfurnuace extends ElementsChemcraft.ModElement {
	@GameRegistry.ObjectHolder("chemcraft:electricfurnuace")
	public static final Block block = null;
	public BlockElectricfurnuace(ElementsChemcraft instance) {
		super(instance, 275);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("electricfurnuace"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "chemcraft:tileentityelectricfurnuace");
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("chemcraft:electricfurnuace", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		public static final PropertyDirection FACING = BlockHorizontal.FACING;
		public BlockCustom() {
			super(Material.IRON);
			setUnlocalizedName("electricfurnuace");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return "container.electricfurnuace";
		}
		...
		public String getGuiID() {
			return "chemcraft:electricfurnuace";
		}
