...
public class BlockConfinedtatp extends ElementsChemcraft.ModElement {
	@GameRegistry.ObjectHolder("chemcraft:confinedtatp")
	public static final Block block = null;
	public BlockConfinedtatp(ElementsChemcraft instance) {
		super(instance, 74);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("confinedtatp"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("chemcraft:confinedtatp", "inventory"));
	}
	public static class BlockCustom extends Block {
		public BlockCustom() {
			super(Material.IRON);
			setUnlocalizedName("confinedtatp");
		...
		public void addInformation(ItemStack itemstack, World world, List<String> list, ITooltipFlag flag) {
			...
			list.add("Power 6.7 extremely sensitive TATP");
		}
			...
			if (world.isBlockIndirectlyGettingPowered(new BlockPos(x, y, z)) > 0) {
				{
					...
					ProcedureConfinedtatpRedstoneOn.executeProcedure($_dependencies);
				}
			} else {
			}
		}
		...
		public void onBlockDestroyedByExplosion(World world, BlockPos pos, Explosion e) {
			...
			int z = pos.getZ();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				ProcedureConfinedtatpBlockDestroyedByExplosion.executeProcedure($_dependencies);
			}
		}
