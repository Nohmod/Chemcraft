...
public class BlockConfined extends ElementsChemcraft.ModElement {
	@GameRegistry.ObjectHolder("chemcraft:confined")
	public static final Block block = null;
	public BlockConfined(ElementsChemcraft instance) {
		super(instance, 49);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("confined"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("chemcraft:confined", "inventory"));
	}
	public static class BlockCustom extends Block {
		public BlockCustom() {
			super(Material.IRON);
			setUnlocalizedName("confined");
		...
		public void onBlockDestroyedByExplosion(World world, BlockPos pos, Explosion e) {
			...
			int z = pos.getZ();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				ProcedureTestBlockDestroyedByExplosion.executeProcedure($_dependencies);
			}
		}
	}
}
