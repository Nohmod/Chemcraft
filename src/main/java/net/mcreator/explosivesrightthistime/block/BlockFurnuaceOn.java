...
public class BlockFurnuaceOn extends ElementsChemcraft.ModElement {
	@GameRegistry.ObjectHolder("chemcraft:furnuaceon")
	public static final Block block = null;
	public BlockFurnuaceOn(ElementsChemcraft instance) {
		super(instance, 172);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("furnuaceon"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "chemcraft:tileentityfurnuaceon");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("chemcraft:furnuaceon", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		public static final PropertyDirection FACING = BlockHorizontal.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("furnuaceon");
		...
		public void randomDisplayTick(IBlockState state, World world, BlockPos pos, Random random) {
			...
			if (true)
				for (int l = 0; l < 8; ++l) {
					double d0 = (double) ((float) i + 0.5) + (double) (random.nextFloat() - 0.5) * 0.6000000014901161D;
					double d1 = ((double) ((float) j + 0.7) + (double) (random.nextFloat() - 0.5) * 0.6000000014901161D) + 0.5;
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getGuiID() {
			return "chemcraft:furnuaceon";
		}

		@Override
		public Container createContainer(InventoryPlayer playerInventory, EntityPlayer playerIn) {
			return new GuiBlast.GuiContainerMod(this.getWorld(), this.getPos().getX(), this.getPos().getY(), this.getPos().getZ(), playerIn);
		}
