...
public class GuiBlast extends ElementsChemcraft.ModElement {
	public static int GUIID = 5;
	public static HashMap guistate = new HashMap();
	public GuiBlast(ElementsChemcraft instance) {
		super(instance, 143);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("chemcraft:textures/blast.png");
		@Override
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			this.drawTexturedModalRect(this.guiLeft + 43, this.guiTop + 29, 0, 0, 256, 256);
		}
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Blast Furnuace", 94, 12, -16777216);
		}
