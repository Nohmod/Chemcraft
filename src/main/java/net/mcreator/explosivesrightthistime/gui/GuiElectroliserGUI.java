...
public class GuiElectroliserGUI extends ElementsChemcraft.ModElement {
	public static int GUIID = 7;
	public static HashMap guistate = new HashMap();
	public GuiElectroliserGUI(ElementsChemcraft instance) {
		super(instance, 187);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 113, 34) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
			}));
			this.customSlots.put(3, this.addSlotToContainer(new Slot(internal, 3, 140, 34) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
			}));
			this.customSlots.put(4, this.addSlotToContainer(new Slot(internal, 4, 10, 70) {
				@Override
			...
			this.customSlots.put(7, this.addSlotToContainer(new Slot(internal, 7, 50, 70) {
				@Override
				public void onSlotChanged() {
					super.onSlotChanged();
			...
			for (si = 0; si < 3; ++si)
				for (sj = 0; sj < 9; ++sj)
					this.addSlotToContainer(new Slot(player.inventory, sj + (si + 1) * 9, 16 + 8 + sj * 18, 13 + 84 + si * 18));
			for (si = 0; si < 9; ++si)
				this.addSlotToContainer(new Slot(player.inventory, si, 16 + 8 + si * 18, 13 + 142));
		}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("chemcraft:textures/electrolisergui.png");
		@Override
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			this.drawTexturedModalRect(this.guiLeft + 58, this.guiTop + 33, 0, 0, 256, 256);
		}
		...
		if (slotID == 6 && changeType == 0) {
			{
				java.util.HashMap<String, Object> $_dependencies = new java.util.HashMap<>();
				$_dependencies.put("entity", entity);
				ProcedureBattery.executeProcedure($_dependencies);
			}
		}
