...
public class GuiSteamcrackerGUI extends ElementsChemcraft.ModElement {
	public static int GUIID = 14;
	public static HashMap guistate = new HashMap();
	public GuiSteamcrackerGUI(ElementsChemcraft instance) {
		super(instance, 445);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 26, 12) {
			}));
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 26, 39) {
			}));
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 26, 66) {
			}));
			int si;
			int sj;
			for (si = 0; si < 3; ++si)
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("chemcraft:textures/steamcrackergui.png");
		@Override
