...
public class GuiChemicaljargui extends ElementsChemcraft.ModElement {
	public static int GUIID = 16;
	public static HashMap guistate = new HashMap();
	public GuiChemicaljargui(ElementsChemcraft instance) {
		super(instance, 468);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 78, 30) {
			}));
			int si;
			int sj;
			for (si = 0; si < 3; ++si)
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("chemcraft:textures/chemicaljargui.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Chemical bottle", 49, 16, -16777216);
		}
