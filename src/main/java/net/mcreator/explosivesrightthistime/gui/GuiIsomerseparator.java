...
import net.mcreator.explosivesrightthistime.procedure.ProcedureISOMERSEP;
...
public class GuiIsomerseparator extends ElementsChemcraft.ModElement {
	public static int GUIID = 4;
	public static HashMap guistate = new HashMap();
	public GuiIsomerseparator(ElementsChemcraft instance) {
		super(instance, 133);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 26, 19) {
			}));
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 69, 19) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
			}));
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 89, 19) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
			}));
			this.customSlots.put(3, this.addSlotToContainer(new Slot(internal, 3, 110, 19) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("chemcraft:textures/isomerseparator.png");
		@Override
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			this.drawTexturedModalRect(this.guiLeft + 47, this.guiTop + 17, 0, 0, 256, 256);
		}
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Isomer separator", 41, 1, -16777216);
		}
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 24, this.guiTop + 46, 80, 20, "separate"));
		}
		...
		if (buttonID == 0) {
			{
				...
				ProcedureISOMERSEP.executeProcedure($_dependencies);
			}
		}
	}
