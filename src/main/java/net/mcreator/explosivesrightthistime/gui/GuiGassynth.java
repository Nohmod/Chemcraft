...
import net.mcreator.explosivesrightthistime.procedure.ProcedureGassnth;
...
public class GuiGassynth extends ElementsChemcraft.ModElement {
	public static int GUIID = 2;
	public static HashMap guistate = new HashMap();
	public GuiGassynth(ElementsChemcraft instance) {
		super(instance, 109);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 20, 12) {
			}));
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 61, 12) {
			}));
			this.customSlots.put(3, this.addSlotToContainer(new Slot(internal, 3, 134, 36) {
			}));
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 61, 36) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
			}));
			this.customSlots.put(4, this.addSlotToContainer(new Slot(internal, 4, 20, 35) {
			}));
			int si;
			int sj;
			for (si = 0; si < 3; ++si)
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("chemcraft:textures/gassynth.png");
		@Override
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			this.drawTexturedModalRect(this.guiLeft + 38, this.guiTop + 11, 0, 0, 256, 256);
		}
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Gas synthesiser", 92, 11, -16777216);
			this.fontRenderer.drawString("Cylinder", 123, 55, -16777216);
		}
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 11, this.guiTop + 58, 100, 20, "Synthesise"));
		}
		...
		if (buttonID == 0) {
			{
				...
				ProcedureGassnth.executeProcedure($_dependencies);
			}
		}
	}
