...
import net.mcreator.explosivesrightthistime.procedure.ProcedureMetalpressprocedure;
...
public class GuiMetalpressGUI extends ElementsChemcraft.ModElement {
	public static int GUIID = 10;
	public static HashMap guistate = new HashMap();
	public GuiMetalpressGUI(ElementsChemcraft instance) {
		super(instance, 284);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 53, 21) {
			}));
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 107, 21) {
				@Override
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("chemcraft:textures/metalpressgui.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Metal press", 61, 2, -16777216);
		}
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 61, this.guiTop + 47, 50, 20, "Press"));
		}
		...
		if (buttonID == 0) {
			{
				...
				ProcedureMetalpressprocedure.executeProcedure($_dependencies);
			}
		}
	}
