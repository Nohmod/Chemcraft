...
public class GuiMoltensaltgui extends ElementsChemcraft.ModElement {
	public static int GUIID = 13;
	public static HashMap guistate = new HashMap();
	public GuiMoltensaltgui(ElementsChemcraft instance) {
		super(instance, 352);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(5, this.addSlotToContainer(new Slot(internal, 5, 8, 21) {
			}));
			int si;
			int sj;
			for (si = 0; si < 3; ++si)
				for (sj = 0; sj < 9; ++sj)
					this.addSlotToContainer(new Slot(player.inventory, sj + (si + 1) * 9, 9 + 8 + sj * 18, 0 + 84 + si * 18));
			for (si = 0; si < 9; ++si)
				this.addSlotToContainer(new Slot(player.inventory, si, 9 + 8 + si * 18, 0 + 142));
		}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("chemcraft:textures/moltensaltgui.png");
		@Override
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			this.drawTexturedModalRect(this.guiLeft + 61, this.guiTop + 20, 0, 0, 256, 256);
		}
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Molten salt electroliser", 43, 2, -16777216);
			this.fontRenderer.drawString("Cathode", 16, 47, -16777216);
			this.fontRenderer.drawString("Anode", 70, 47, -16777216);
			this.fontRenderer.drawString("Battery", 124, 47, -16777216);
			this.fontRenderer.drawString("Flux", 7, 11, -16777216);
		}
